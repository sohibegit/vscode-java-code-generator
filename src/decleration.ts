...
export class Decleration implements IDecleration {
    constructor(public variableType: string, public variableName: string, public isFinal: boolean, public isFinalValueAlradySet: boolean, public annotation: string) {}
